...
* File Name: mv.c
*
* Description: Implementation of the 'mv' command for the shell.
*
...
/******************************************************************************
* Function Name: main_mv
********************************************************************************
* Summary:
*   Implementation of the 'mv' command for the shell.
*
* Parameters:
*   argc: Argument count.
...
int main_mv(int argc, char** argv) 
{
    ...
    {
        printf("Failed to rename entry. %s\n", strerror(errno));
        return -1;
    }
