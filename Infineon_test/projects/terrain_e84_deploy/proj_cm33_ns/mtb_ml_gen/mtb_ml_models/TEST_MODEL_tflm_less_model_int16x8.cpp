...
const TensorInfo_t tensorData[] = {
  ...
  { kTfLiteInt16, tensor_arena + 80, (TfLiteIntArray*)&tensor_dimension9, 20, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant9)) },},
  { kTfLiteInt16, tensor_arena + 48, (TfLiteIntArray*)&tensor_dimension10, 20, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant10)) },},
};
...
OpData TEST_MODEL_op_user_data[] = {
  {{0, 0, 0, 32767, 0, 0, 0, 0, 0, nullptr, nullptr, false}, TEST_MODEL_op_user_data0_per_channel_output_multiplier, TEST_MODEL_op_user_data0_per_channel_output_shift, -1, TEST_MODEL_op_user_data0_kernel_sums, 0, 0, 0, nullptr, 0, 0, EvalQuantizedInt8NNLite, {9.631681605242e-04}}, 
  {{0, 0, 0, 32767, 0, 0, 0, 0, 0, nullptr, nullptr, false}, TEST_MODEL_op_user_data1_per_channel_output_multiplier, TEST_MODEL_op_user_data1_per_channel_output_shift, -1, TEST_MODEL_op_user_data1_kernel_sums, 0, 0, 0, nullptr, 0, 0, EvalQuantizedInt8NNLite, {1.141574140638e-02}}, 
  {{0, 0, -32768, 32767, 0, 0, 0, 0, 0, nullptr, nullptr, false}, TEST_MODEL_op_user_data2_per_channel_output_multiplier, TEST_MODEL_op_user_data2_per_channel_output_shift, -1, TEST_MODEL_op_user_data2_kernel_sums, 0, 0, 0, nullptr, 0, 0, EvalQuantizedInt8NNLite, {6.289996206760e-03}}
};
} // namespace fully_connected
...
OpData TEST_MODEL_op_user_data[] = {
  {0, {1, 10, 0, 0}, {3.922079224139e-03, 0, 3.051757812500e-05, 0, {-32768, 32767}, (cy_en_nnlite_activation_size_t)(1), (cy_en_nnlite_output_size_t)(1), nullptr}, SoftmaxQuantizedInt16}
};
} // namespace softmax
