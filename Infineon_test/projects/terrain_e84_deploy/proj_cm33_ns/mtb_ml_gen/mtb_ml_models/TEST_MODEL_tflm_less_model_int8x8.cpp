...
#if TF_LITE_MICRO_USE_OFFLINE_OP_USER_DATA
#include "ifx_mxnnlite2/addsub_op_data.h"
#include "ifx_mxnnlite2/conv_op_data.h"
#include "ifx_mxnnlite2/depthwise_conv_op_data.h"
#include "ifx_mxnnlite2/fully_connected_op_data.h"
#include "ifx_mxnnlite2/mul_op_data.h"
#include "ifx_mxnnlite2/pooling_op_data.h"
#include "ifx_mxnnlite2/softmax_op_data.h"
#include "ifx_mxnnlite2/addsub_op_data.h"
...
const TensorInfo_t tensorData[] = {
  ...
  { kTfLiteInt8, tensor_arena + 64, (TfLiteIntArray*)&tensor_dimension9, 10, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant9)) },},
  { kTfLiteInt8, tensor_arena + 48, (TfLiteIntArray*)&tensor_dimension10, 10, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&quant10)) },},
};
...
::tflite::ops::micro::addsubmul::VariantOpData TEST_MODEL_op_user_data[] = {
};
} // namespace add
...
OpData TEST_MODEL_op_user_data[] = {
  {{0, 0, -128, 127, 0, -128, 0, -128, 0, nullptr, nullptr, false}, TEST_MODEL_op_user_data0_per_channel_output_multiplier, TEST_MODEL_op_user_data0_per_channel_output_shift, -1, TEST_MODEL_op_user_data0_kernel_sums, 0, 0, 0, nullptr, 0, 0, EvalQuantizedInt8NNLite, {9.631681023166e-04}}, 
  {{0, 0, -128, 127, 0, -128, 0, -128, 0, nullptr, nullptr, false}, TEST_MODEL_op_user_data1_per_channel_output_multiplier, TEST_MODEL_op_user_data1_per_channel_output_shift, -1, TEST_MODEL_op_user_data1_kernel_sums, 0, 0, 0, nullptr, 0, 0, EvalQuantizedInt8NNLite, {1.141574140638e-02}}, 
  {{0, 0, -128, 127, 0, -128, 0, 48, 0, nullptr, nullptr, false}, TEST_MODEL_op_user_data2_per_channel_output_multiplier, TEST_MODEL_op_user_data2_per_channel_output_shift, -1, TEST_MODEL_op_user_data2_kernel_sums, 0, 0, 0, nullptr, 0, 0, EvalQuantizedInt8NNLite, {4.338091704994e-03}}
};
} // namespace fully_connected
...
OpData TEST_MODEL_op_user_data[] = {
  {0, {1, 10, 0, 0}, {7.307428121567e-01, -48, 3.906250000000e-03, -128, {-128, 127}, (cy_en_nnlite_activation_size_t)(0), (cy_en_nnlite_output_size_t)(0), nullptr}, SoftmaxQuantizedInt8}
};
} // namespace softmax
