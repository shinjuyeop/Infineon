...
The following example clones the "[DEEPCRAFT&trade; Studio Deploy Motion](https://github.com/Infineon/mtb-example-psoc-edge-ml-deepcraft-deploy-motion)" application with the desired name "DeployMotion" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-ml-deepcraft-deploy-motion --user-app-name DeployMotion --target-dir "C:/mtb_projects"
   ```
