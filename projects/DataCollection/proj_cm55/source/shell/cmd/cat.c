...
* File Name: cat.c
*
* Description: Implementation of the 'cat' command for the shell.
*
...
*******************************************************************************/
/******************************************************************************
* Function Name: main_cat
********************************************************************************
* Summary:
*   Implementation of the 'cat' command for the shell.
*
* Parameters:
*   argc: Argument count.
...
int main_cat(int argc, char** argv)
{
    ...
    FILE* file = fopen(argv[go.optind], "r");
    if (file == NULL) {
