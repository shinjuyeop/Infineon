...
* File Name: dhalt.c
*
* Description: Implementation of the 'dhalt' command for the shell.
*
...
*******************************************************************************/
/******************************************************************************
* Function Name: main_dhalt
********************************************************************************
* Summary:
*   Implementation of the 'dhalt' command for the shell. This command halts all 
*   active devices.
*
* Parameters:
*   argc: Argument count.
...
int main_dhalt(int argc, char** argv) 
{
    ...
    {
        protocol_Device* device = &protocol->board.devices[i];
        ...
        {
            printf("Halting device %s\n", device->name);
            manager->stop(protocol, device->device_id, manager->busy, manager->arg);
        }
    }
